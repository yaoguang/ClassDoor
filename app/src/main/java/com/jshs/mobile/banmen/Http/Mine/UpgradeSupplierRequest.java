 ...
 */
public class UpgradeSupplierRequest extends PostRequest<String> {
    public UpgradeSupplierRequest(Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Domain.UPGRADE_SUPPLIER, listener, errorListener);
    }
