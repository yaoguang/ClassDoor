 ...
 */
public class AddFriendRequest extends GetRequest<Result> {

    public AddFriendRequest(int pid, Response.Listener<Result> listener, Response.ErrorListener errorListener) {
        super(formatUrl(Domain.ADD_FRIEND, new String[]{"pid"}, String.valueOf(pid)), listener, errorListener);
    }
