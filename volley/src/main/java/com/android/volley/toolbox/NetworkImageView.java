...
public class NetworkImageView extends ImageView {
     ...
     * 请求成功背景色颜色
     */
    private int mSuccessBackId;
    /**
     * 请求失败背景色颜色
     */
    private int mErrorBackId;
    /**
     * 默认背景色颜色
     */
     ...
     * 透明背景色
     */
    private int mLucencyColor = 0x00000000;
    ...
    public void setBackColorModesResId(int defaultBack, int successBack, int errorBack) {
        mDefaultBackId = defaultBack;
        mSuccessBackId = successBack;
        mErrorBackId = errorBack;
    }
        ...
        ImageContainer newContainer = mImageLoader.get(tmpUrl,
                new ImageListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (mErrorBackId != 0) {
                            setBackgroundColor(getResources().getColor(mErrorBackId));
                        }
                    }
                    ...
                    public void onResponse(final ImageContainer response, boolean isImmediate) {
                        ...
                        if (response.getBitmap() != null) {
                            ...
                            if (mSuccessBackId != 0)
                                setBackgroundColor(getResources().getColor(mSuccessBackId));
                        } else {
                            if (mDefaultImageId != 0) {
                                setImageResource(mDefaultImageId);
                            }
                            if (mDefaultBackId != 0) {
                                setBackgroundColor(getResources().getColor(mDefaultBackId));
                            }
                        }
                    }
    ...
    private void setDefaultBackColorOrNull() {
        if (mDefaultBackId != 0) {
            setBackgroundColor(getResources().getColor(mDefaultBackId));
        } else {
            setBackgroundColor(mLucencyColor);
        }
    }
