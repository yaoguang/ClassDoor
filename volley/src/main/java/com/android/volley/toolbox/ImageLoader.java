...
public class ImageLoader {
    ...
    public boolean isCached(String requestUrl, int maxWidth, int maxHeight) {
        return isCached(requestUrl, maxWidth, maxHeight, ScaleType.CENTER_INSIDE, null);
    }
    ...
    public boolean isCached(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType) {
        return isCached(requestUrl, maxWidth, maxHeight, scaleType, null);
    }
     ...
     * @return True if the item exists in cache, false otherwise.
     */
    public boolean isCached(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, ImageRequest.Transformation transformation) {
        throwIfNotOnMainThread();

        String cacheKey = getCacheKey(requestUrl, maxWidth, maxHeight, scaleType, transformation);
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        return get(requestUrl, imageListener, maxWidth, maxHeight, scaleType, null);
    }
     ...
     * @param scaleType The ScaleType of the output.
     * @param transformation The ImageRequest.Transformation of the output.
     */
